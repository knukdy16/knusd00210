...
public class ProductList { // 한글로 물품목록
	...
	*/
	...
	public Product searchProduct(String ProductCode) { // 물품검색(). 정보를 입력받아서 Product Object's Array에서 해당하는 정보를 찾아서 Product 객체를 반환.
		Product Search = null;
		this.setProductList();
	...
	public Product _searchProduct() { // 물품검색(). 정보를 입력받아서 Product 객체를 반환. 반환예시를 위한 example로, 제출 전에 삭제 요망.
